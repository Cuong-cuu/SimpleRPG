...
public class Enemy1 extends Enemy
{
	...
	public Enemy1()
	{
		...
		walking.setImage(new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"01"+".png"));
		...
		attack.setImage(new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"01"+".png"));
		...
		death.setImage(new Image(ImgLink+"death"+"_"+"enemy"+"_"+"01"+".png"));
		...
		hurted.setImage(new Image(ImgLink+"hurted"+"_"+"player"+"_"+"01"+".png"));
		...
		spawn.setImage(new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"01"+".png"));
	...
	{	
		SetUpAnimation(
				walking,
				new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"01"+".png"),
				walkingani,
				Duration.millis(800),
				5,
				5,
	...
	private void Attack(double directionX,Player player)
	{
		SetUpAnimation(
				attack,
				new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"01"+".png"),
				attackani,
	...
	public void Spawn(double X,double Y)
	{
		...
		SetUpAnimation(
				spawn,
				new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"01"+".png"),
				spawnani,
	...
	public void Death()
	{
		...
		SetUpAnimation(
				death,
				new Image(ImgLink+"death"+"_"+"enemy"+"_"+"01"+".png"),
				deathani,
				Duration.millis(1000),
				5,
				5,
	...
	public void Hurted(double Damage)
	{
		...
		SetUpAnimation(
				hurted,
				new Image(ImgLink+"hurted"+"_"+"enemy"+"_"+"01"+".png"),
				hurtedani,
				Duration.millis(200),
				2,
				2,
