...
public class Enemy4 extends Enemy 
{
	...
	public Enemy4()
	{
		...
		walking.setImage(new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"04"+".png"));
		...
		attack.setImage(new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"04"+".png"));
		...
		death.setImage(new Image(ImgLink+"death"+"_"+"enemy"+"_"+"04"+".png"));
		...
		hurted.setImage(new Image(ImgLink+"hurted"+"_"+"player"+"_"+"04"+".png"));
		...
		spawn.setImage(new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"04"+".png"));
	...
	{	
		SetUpAnimation(
				walking,
				new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"04"+".png"),
				walkingani,
				Duration.millis(800),
				3,
				3,
	...
	private void Attack(double directionX,Player player)
	{
		SetUpAnimation(
				attack,
				new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"04"+".png"),
				attackani,
	...
	public void Spawn(double X,double Y)
	{
		...
		SetUpAnimation(
				spawn,
				new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"04"+".png"),
				spawnani,
	...
	public void Death()
	{
		...
		SetUpAnimation(
				death,
				new Image(ImgLink+"death"+"_"+"enemy"+"_"+"04"+".png"),
				deathani,
				Duration.millis(1000),
				3,
				3,
	...
	public void Hurted(double Damage)
	{
		...
		SetUpAnimation(
				hurted,
				new Image(ImgLink+"hurted"+"_"+"enemy"+"_"+"04"+".png"),
				hurtedani,
				Duration.millis(200),
				3,
				3,
