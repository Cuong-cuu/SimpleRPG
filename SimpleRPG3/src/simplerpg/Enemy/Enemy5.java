...
public class Enemy5 extends Enemy{
	...
	public Enemy5()
	{
		...
		this.MaxHP =10*Launcher.difficulty;
		this.hp = 10*Launcher.difficulty;
		this.Damage = 30*Launcher.difficulty;
		...
		walking.setImage(new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"05"+".png"));
		walkingani = new SpriteAnimation(walking, Duration.millis(800), 3, 3, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());		
	
		///Attack animation
		attack.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		attack.setImage(new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"05"+".png"));
		attackani = new SpriteAnimation(attack, Duration.millis(1000*this.AttackSpeed), 3, 3, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
				
		///Death animation
		death.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		death.setImage(new Image(ImgLink+"death"+"_"+"enemy"+"_"+"05"+".png"));
		deathani = new SpriteAnimation(death, Duration.millis(1000), 3, 3, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
				
		///Hurted animation
		hurted.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		hurted.setImage(new Image(ImgLink+"hurted"+"_"+"player"+"_"+"05"+".png"));
		...
		spawn.setImage(new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"05"+".png"));
		spawnani = new SpriteAnimation(spawn,Duration.millis(1000),3, 3, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
	...
	{	
		SetUpAnimation(
				walking,
				new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"05"+".png"),
				walkingani,
				Duration.millis(800),
				3,
				3,
	...
	private void Attack(double directionX,Player player)
	{
		SetUpAnimation(
				attack,
				new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"05"+".png"),
				attackani,
	...
	public void Spawn(double X,double Y)
	{
		...
		SetUpAnimation(
				spawn,
				new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"05"+".png"),
				spawnani,
	...
	public void Death()
	{
		...
		SetUpAnimation(
				death,
				new Image(ImgLink+"death"+"_"+"enemy"+"_"+"05"+".png"),
				deathani,
				Duration.millis(1000),
				3,
				3,
	...
	public void Hurted(double Damage)
	{
		...
		SetUpAnimation(
				hurted,
				new Image(ImgLink+"hurted"+"_"+"enemy"+"_"+"05"+".png"),
				hurtedani,
				Duration.millis(200),
				3,
				3,
