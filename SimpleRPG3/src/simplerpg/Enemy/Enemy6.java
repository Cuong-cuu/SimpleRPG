...
public class Enemy6 extends Enemy{
	...
	public Enemy6()
	{
		...
		walking.setImage(new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"06"+".png"));
		walkingani = new SpriteAnimation(walking, Duration.millis(800), 5, 5, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());		
	
		///Attack animation
		attack.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		attack.setImage(new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"06"+".png"));
		attackani = new SpriteAnimation(attack, Duration.millis(1500*this.AttackSpeed), 5, 5, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
				
		///Death animation
		death.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		death.setImage(new Image(ImgLink+"death"+"_"+"enemy"+"_"+"06"+".png"));
		deathani = new SpriteAnimation(death, Duration.millis(1000), 5, 5, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
				
		///Hurted animation
		hurted.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		hurted.setImage(new Image(ImgLink+"hurted"+"_"+"player"+"_"+"06"+".png"));
		hurtedani = new SpriteAnimation(hurted, Duration.millis(200), 2, 2, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
				
		///Spawn
		spawn.setViewport(new Rectangle2D(0, 0, this.getBgwidth(), this.getBgheight()));
		spawn.setImage(new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"06"+".png"));
		spawnani = new SpriteAnimation(spawn,Duration.millis(1000),5, 5, this.getBgwidth(), this.getBgheight(),this.getBgwidth(),this.getBgheight());
	...
	{	
		SetUpAnimation(
				walking,
				new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"06"+".png"),
				walkingani,
				Duration.millis(800),
				5,
				5,
	...
	private void Attack(double directionX,Player player)
	{
		SetUpAnimation(
				attack,
				new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"06"+".png"),
				attackani,
	...
	public void Spawn(double X,double Y)
	{
		...
		SetUpAnimation(
				spawn,
				new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"06"+".png"),
				spawnani,
	...
	public void Death()
	{
		...
		SetUpAnimation(
				death,
				new Image(ImgLink+"death"+"_"+"enemy"+"_"+"06"+".png"),
				deathani,
				Duration.millis(1000),
				5,
				5,
	...
	public void Hurted(double Damage)
	{
		...
		SetUpAnimation(
				hurted,
				new Image(ImgLink+"hurted"+"_"+"enemy"+"_"+"06"+".png"),
				hurtedani,
				Duration.millis(200),
				2,
				2,
