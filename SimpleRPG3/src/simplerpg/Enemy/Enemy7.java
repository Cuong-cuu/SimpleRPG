...
public class Enemy7 extends Enemy {
	...
	public Enemy7()
	{
		...
		walking.setImage(new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"07"+".png"));
		...
		attack.setImage(new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"07"+".png"));
		...
		death.setImage(new Image(ImgLink+"death"+"_"+"enemy"+"_"+"07"+".png"));
		...
		hurted.setImage(new Image(ImgLink+"hurted"+"_"+"player"+"_"+"07"+".png"));
		...
		spawn.setImage(new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"07"+".png"));
	...
	{	
		SetUpAnimation(
				walking,
				new Image(ImgLink+"walking"+"_"+"enemy"+"_"+"07"+".png"),
				walkingani,
				Duration.millis(800),
				5,
				5,
	...
	private void Attack(double directionX,Player player)
	{
		SetUpAnimation(
				attack,
				new Image(ImgLink+"attack"+"_"+"enemy"+"_"+"07"+".png"),
				attackani,
	...
	public void Spawn(double X,double Y)
	{
		...
		SetUpAnimation(
				spawn,
				new Image(ImgLink+"spawn"+"_"+"enemy"+"_"+"07"+".png"),
				spawnani,
	...
	public void Death()
	{
		...
		SetUpAnimation(
				death,
				new Image(ImgLink+"death"+"_"+"enemy"+"_"+"07"+".png"),
				deathani,
				Duration.millis(1000),
				5,
				5,
	...
	public void Hurted(double Damage)
	{
		...
		SetUpAnimation(
				hurted,
				new Image(ImgLink+"hurted"+"_"+"enemy"+"_"+"07"+".png"),
				hurtedani,
				Duration.millis(500),
				3,
				3,
